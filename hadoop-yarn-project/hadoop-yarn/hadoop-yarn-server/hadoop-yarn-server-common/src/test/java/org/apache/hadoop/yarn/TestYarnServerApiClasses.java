...
public class TestYarnServerApiClasses {
  ...
  private DecreasedContainer getDecreasedContainer(int containerID,
    ...
    return DecreasedContainer.newInstance(containerId, capability);
  }

  private IncreasedContainer getIncreasedContainer(int containerID,
      int appAttemptId, int memory, int vCores) {
    ContainerId containerId = getContainerId(containerID, appAttemptId);
    Resource capability = Resource.newInstance(memory, vCores);
    return IncreasedContainer.newInstance(containerId, capability, null);
  }
