...
public class TestPBImplRecords {
  ...
  @Test
  public void testDecreasedContainerPBImpl() throws Exception {
    validatePBImplRecord(DecreasedContainerPBImpl.class,
        DecreasedContainerProto.class);
  }

  @Test
  public void testIncreasedContainerPBImpl() throws Exception {
    validatePBImplRecord(IncreasedContainerPBImpl.class,
        IncreasedContainerProto.class);
  }
